...
VALUES ('Wadi Rum Hike', 'Climb desert dunes to see gorgeous sunsets over Wadi Rum.', 200.00, 100, 'static/images/wadi_rum.jpeg', 'Hikes');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Trek to Petra', 'Visit the the lost city of Petra in all its glory.', 300.00, 100, 'static/images/petra.jpeg', 'Hikes');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Dana Biosphere Hike', 'Gaze upon the diverse ecosystems of the Dana Biosphere.', 400.00, 100, 'static/images/dana.jpeg', 'Hikes');
